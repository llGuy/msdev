...
#include "../../var-storage/dat-struct/Vector.h"
...
namespace CLine {
	...
	public:
		...
		virtual const bool M_IsRetState(void) { return false; };
		virtual const bool M_HasRetState(void) { return false; };
		virtual const std::string* M_RetRSV(void) { return nullptr; };
	};
}
#endif